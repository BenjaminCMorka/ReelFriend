        ...
        <>
            {showOnboarding ? (
                ...
                >
                    ...
                    <div className="onboarding-modal bg-navy p-6 rounded-lg shadow-lg w-3/4 mx-auto text-white">
                        <h2 className="text-xl font-bold">Let me get to know you better...</h2>
                        <p className="text-lg mt-2">{questions[currentStep]}</p>

                        {currentStep === 0 && (
                            <div className="grid grid-cols-3 gap-x-6 gap-y-4 my-5">
                                {genres.map(genre => (
                                    <button
                                        key={genre}
                    ...
                    {!animationComplete ? (
                        <div className="relative w-full max-w-lg h-64 flex items-center justify-center">
                            {welcomeSlides.map((text, index) => (
                                ...
                                >
                                    <h1 className={"font-semibold whitespace-nowrap text-5xl mb-2"}>
                                        {text}
                                    </h1>
                                </motion.div>
                            ))}
